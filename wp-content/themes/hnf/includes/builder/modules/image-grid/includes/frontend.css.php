...
@media (max-width: <?php echo $global_settings->responsive_breakpoint; ?>px) {
	...
	.fl-node-<?php echo $id ?> .hnf-image-grid-item {
		width: calc( 1/<?php echo (int)$settings->columns_responsive; ?>*100% - (1 - 1/<?php echo (int)$settings->columns_responsive; ?>) * <?php echo (int)$settings->gutters_responsive ?>.01px );
	}
...
@media (min-width: <?php echo $global_settings->responsive_breakpoint; ?>px) and (max-width: <?php echo $global_settings->medium_breakpoint ?>px) {
	...
	.fl-node-<?php echo $id ?> .hnf-image-grid-item {
		width: calc( 1/<?php echo (int)$settings->columns_medium; ?>*100% - (1 - 1/<?php echo (int)$settings->columns_medium; ?>) * <?php echo (int)$settings->gutters_medium ?>.01px );
...
@media (min-width: <?php echo $global_settings->medium_breakpoint; ?>px) {
	...
	.fl-node-<?php echo $id ?> .hnf-image-grid-item {
		width: calc( 1/<?php echo (int)$settings->columns; ?>*100% - (1 - 1/<?php echo (int)$settings->columns; ?>) * <?php echo (int)$settings->gutters ?>.01px );
